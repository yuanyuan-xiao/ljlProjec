...
<script>
import Cjpm from "@/views/student/components/xmcjpm.vue";
import Bjpm from "@/views/student/components/bjcjpm.vue";
import Grpm from "@/views/student/components/grpm.vue";
export default {
  name: "ckpm",
  props: {},
